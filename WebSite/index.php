                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 mx-auto tm-about-text-wrap text-center">                        
                            <h2 class="text-uppercase mb-4">Discovering <strong>Jordan</strong> is our priority</h2>
            ...
            <div class="tm-container-outer" id="tm-section-2">
                <section class="tm-slideshow-section">
                    ...
                    <div class="tm-slideshow-description tm-bg-primary">
                        <h2 class="">Jordan's most visited places</h2>
            ...
            <div class="tm-container-outer" id="tm-section-3">
                <ul class="nav nav-pills tm-tabs-links">
                    <?php
                        ...
                        $result_cities = mysqli_query( $link , $select_cities );
                        if( mysqli_num_rows( $result_cities ) >0 ){
                            while( $row_cities = mysqli_fetch_array( $result_cities )){
                                echo '
                                <li class="tm-tab-link-li">
                                    <a onclick="getData('.$row_cities["id"].')" href="#1a" data-toggle="tab" class="tm-tab-link">
                                        <img src="../admin/uploads/'.$row_cities["image"].'" alt="Image" class="img-fluid">
                                        '.$row_cities["address"].'
                                    </a>
                                </li>
                                ';
                ...
                <div class="tab-content clearfix">
                    ...
                    <div class="tab-pane fade" id="1a">
                        <div class="tm-recommended-place-wrap" id="resultAjax">
