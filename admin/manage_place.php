...
if(isset($_POST['addBtn'])){
    ...
    $query = "INSERT INTO tourist_place (`nameplace`, `des`, `img`, `lat`, `lon`, `city_id`) VALUE ('$nameplace','$desc','$img','$lat','$lon','$city_id')";
            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form action="#" method="post" class="" enctype="multipart/form-data">
                        ...
                        <div class="form-actions form-group"><button type="submit" name="addBtn" class="btn btn-success btn-sm">Add Place</button></div>
                    </form>
                </div>
            </div>
        </div>
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="delete_place.php?id=<?php echo $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('are you sure?')"><i class="fa fa-trash fa-sm"></i></a>
